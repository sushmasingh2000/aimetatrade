        ...
        {!loading && data?.data?.length === 0 && (
          ...
          >
            <Typography sx={{ fontSize: 16, fontWeight: 600 }}>
              No  Referral Level Bonus  Found
            </Typography>
            <Typography sx={{ fontSize: 13, color: '#aaa', mt: 1 }}>
              You haven’t made any  Referral Level Bonus  yet.
            </Typography>
          </Box>
        )}
